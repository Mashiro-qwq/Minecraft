...
Network Minecraft Server Version: 1.21.10 <span style="color: rgb(255, 20, 147)">Update Time : 2025/11/21 00:46:34
...
- 服务端文件 [server_1.21.10](https://fubuki.lanzoue.com/ibfXN380need) | [服务端文件归档](https://fubuki.lanzoub.com/b00tgp19g)
    - 集成的MOD：32个 ( 基于 [Fabric](https://fabricmc.net/) 加载器 version 1.1.0 和 [Iris](https://www.irisshaders.dev/) 光影着色器 version 3.2.1 )
        ...
        - [[地毯附加]Carpet Tis Addition](https://modrinth.com/mod/carpet-tis-addition) version 1.71.1
        - [[RNG附魔]Clientcommands](https://modrinth.com/mod/client-commands) version 2.12.2
        - [[地平线]DistantHorizons](https://modrinth.com/mod/distantHorizons) version 2.3.6-b
        - [[耐久显示]Durability Viewer Updated](https://modrinth.com/mod/durability-viewer-updated) version 1.11.1
        - [[Fabric运行库]Fabric-api](https://modrinth.com/mod/fabric-api) version 0.138.3
        - [[地毯]Carpet](https://modrinth.com/mod/carpet) version 1.4.188+v251016
        - [[Kotlin支持]Fabric Language Kotlin](https://modrinth.com/mod/fabric-language-kotlin) version 1.13.7+kotlin.2.2.21
        - [[R键整理]Inventory Profiles Next](https://modrinth.com/mod/inventory-profiles-next) version 2.2.1
        - [[Iris光影着色器]Iris Shaders](https://modrinth.com/mod/iris) version 1.9.6
        - [[物品滚轮]Item Scroller](https://modrinth.com/mod/item-scroller) version 0.29.2
        - [[IPN库]libIPN](https://modrinth.com/mod/libipn) version 6.6.1
        - [[投影]Litematica](https://modrinth.com/mod/litematica) version 0.24.5
        - [[锂-优化]Lithium](https://modrinth.com/mod/lithium) version 0.20.1
        - [[魔法库]MagicLib](https://modrinth.com/mod/magiclib) version 0.8.781-beta
        - [[masa运行库]MaLiLib](https://modrinth.com/mod/malilib) version 0.26.6
        - [[迷你信息]MiniHUD](https://modrinth.com/mod/minihud) version 0.37.3
        ...
        - [[钠-界面替换]reeses sodium options](https://modrinth.com/mod/reeses-sodium-options) version 1.8.5
        - [[回放]Replay](https://modrinth.com/mod/replaymod) version 2.6.24
        - [[MiniHUD服务端组件]Servux](https://modrinth.com/mod/servux) version 0.8.3
        - [[钠-附加]Sodium Extra](https://modrinth.com/mod/sodium-extra) version 0.7.0
        - [[钠]Sodium](https://modrinth.com/mod/sodium) version 0.7.3
        - [[技巧操作附加]Tweakermore](https://modrinth.com/mod/tweakermore) version 3.27.1
        - [[技巧操作]Tweakeroo](https://modrinth.com/mod/tweakeroo) version 0.26.3
        - [[Voxel小地图]VoxelMap Updated](https://modrinth.com/mod/voxelmap-updated) version 1.15.9
        - [[目标显示]Wthit](https://modrinth.com/mod/wthit) version 17.3.3
        - [[自动钓鱼]XplusAutofish](https://modrinth.com/mod/x+-autofish) version 1.4.1
        - [[粒子雨前置]YetAnotherConfigLib](https://modrinth.com/mod/yacl) version 3.8.0
...
- [MC-610](https://bugs.mojang.com/browse/MC-610) - 在新创建的区块中，草、花和雪生成的位置不正确。
...
- [MC-121897](https://bugs.mojang.com/browse/MC-121897) - 动画所用帧中的间隔引发ArrayIndexOutOfBoundsException。
...
- [MC-167977](https://bugs.mojang.com/browse/MC-167977) - 如果在巨型云杉树生成的灰化土上方有雪，灰化土不显示为覆盖雪的材质。
...
- [MC-183884](https://bugs.mojang.com/browse/MC-183884) - 潜影贝害怕与另一个潜影贝相邻。
- [MC-183917](https://bugs.mojang.com/browse/MC-183917) - entity_scores条件要求同时填写min和max。
- [MC-185357](https://bugs.mojang.com/browse/MC-185357) - 取出花盆内的花时会播放“盔甲：装备”的音效。
- [MC-185359](https://bugs.mojang.com/browse/MC-185359) - 生存模式下使用水桶时会播放“盔甲：装备”的音效。
- [MC-185360](https://bugs.mojang.com/browse/MC-185360) - 对哞菇使用碗时会播放“盔甲：装备”的音效。
- [MC-185605](https://bugs.mojang.com/browse/MC-185605) - 海带会生成在岩浆块上。
- [MC-186172](https://bugs.mojang.com/browse/MC-186172) - 潜影贝在无法被传送时，其张开的壳会与方块重叠。
- [MC-186864](https://bugs.mojang.com/browse/MC-186864) - 皮革盔甲会出现白色。
- [MC-186879](https://bugs.mojang.com/browse/MC-186879) - 站在水与火焰中时，火焰熄灭声会一直播放。
- [MC-187544](https://bugs.mojang.com/browse/MC-187544) - “钻石护体”进度的英文名称中大小写不正确。
- [MC-187664](https://bugs.mojang.com/browse/MC-187664) - 世界边界使用浮点数决定其大小，使得其大小无法被设置为某些值，且无法设置为3000万及以上。
- [MC-188044](https://bugs.mojang.com/browse/MC-188044) - 对装满液体的炼药锅使用旗帜时会播放手部动画。
- [MC-188448](https://bugs.mojang.com/browse/MC-188448) - 营火熄灭时，其上的食物会掉落。
- [MC-189336](https://bugs.mojang.com/browse/MC-189336) - 在服务器列表中按住⇧ Shift键移动服务器时会导致游戏崩溃（ArrayIndexOutOfBoundsException）。
- [MC-189482](https://bugs.mojang.com/browse/MC-189482) - Tab ↹键无法按正确的顺序选中局域网世界设置界面中的按钮。
- [MC-189535](https://bugs.mojang.com/browse/MC-189535) - 创造模式中，玩家用桶捕鱼不会给予玩家一个新桶。
- [MC-189565](https://bugs.mojang.com/browse/MC-189565) - 刷怪笼内的一些实体无法渲染，并且这会使控制台被错误日志刷屏进而导致卡顿。
- [MC-189885](https://bugs.mojang.com/browse/MC-189885) - 读取通信包中previousGamemode字节的方式不正确。
- [MC-190128](https://bugs.mojang.com/browse/MC-190128) - 游戏内统计不追踪使用打火石点燃TNT的操作。
- [MC-190454](https://bugs.mojang.com/browse/MC-190454) - 玩家骑着一匹骑着另一个生物的马时会出现不同步现象，导致那个生物死亡。
- [MC-190677](https://bugs.mojang.com/browse/MC-190677) - 潜影贝在生成后一瞬间没有对准网格。
- [MC-190774](https://bugs.mojang.com/browse/MC-190774) - 切石机的刀片同时向两个方向旋转。
- [MC-190896](https://bugs.mojang.com/browse/MC-190896) - 打开装有藏宝图的沉船遗迹宝箱时会产生卡顿。
- [MC-190952](https://bugs.mojang.com/browse/MC-190952) - 制作者名单中，“Developers of Mo' Creatures”标题里的撇号与的其他地方的撇号不一致。
- [MC-191338](https://bugs.mojang.com/browse/MC-191338) - 命令方块矿车的名字颜色不正确。
- [MC-191714](https://bugs.mojang.com/browse/MC-191714) - 玩家在耕地上骑马或坐船时，如果此时耕地变为泥土，则玩家会落地，且导致不同步。
- [MC-192591](https://bugs.mojang.com/browse/MC-192591) - 结构空位的名字颜色不正确。
- [MC-192594](https://bugs.mojang.com/browse/MC-192594) - 结构plains_stable_1的拼图设置不正确。
- [MC-192629](https://bugs.mojang.com/browse/MC-192629) - 结构plains_stable_2的拼图设置不正确。
- [MC-192876](https://bugs.mojang.com/browse/MC-192876) - 结构taiga_decoration_6中一扇活板门的位置有误。
- [MC-192879](https://bugs.mojang.com/browse/MC-192879) - 针叶林村庄中一些房屋中的墙的连接方向有误。
- [MC-192889](https://bugs.mojang.com/browse/MC-192889) - 放置特定头颅或把它放在生物头盔槽内时会导致游戏回弹。
- [MC-192930](https://bugs.mojang.com/browse/MC-192930) - 僵尸拾起物品时会播放“盔甲：装备”的音效。
- [MC-193071](https://bugs.mojang.com/browse/MC-193071) - 食用带容器的食物（如蘑菇煲、牛奶桶等）后会播放“盔甲：装备”的音效。
- [MC-193386](https://bugs.mojang.com/browse/MC-193386) - 附着在地面的潜影贝在另一只潜影贝被生成后，它们都会侧向附着在附近的方块上。
- [MC-194089](https://bugs.mojang.com/browse/MC-194089) - 在某些高度的潜影贝拒绝获得“Peek”值。
- [MC-194183](https://bugs.mojang.com/browse/MC-194183) - 收集到的经验值不完全用于修复带有经验修补附魔的物品。
- [MC-194675](https://bugs.mojang.com/browse/MC-194675) - 当旁观苦力怕、末影人、蜘蛛或洞穴蜘蛛时，UI部分会被渲染成全白。
- [MC-194685](https://bugs.mojang.com/browse/MC-194685) - 创造模式下使用玻璃瓶收集炼药锅中的水不会得到水瓶。
- [MC-194686](https://bugs.mojang.com/browse/MC-194686) - 创造模式下使用桶收集炼药锅中的水不会得到水桶。
- [MC-195125](https://bugs.mojang.com/browse/MC-195125) - 结构plains_animal_pen_1的拼图设置不正确。
- [MC-195126](https://bugs.mojang.com/browse/MC-195126) - 结构plains_animal_pen_3的拼图设置不正确。
- [MC-195351](https://bugs.mojang.com/browse/MC-195351) - 比较模式下的比较器可以计划不需要的附加刻。
- [MC-195461](https://bugs.mojang.com/browse/MC-195461) - 仙人掌盆栽和竹子盆栽上方存在上半台阶时，其顶部材质会消失。
- [MC-195640](https://bugs.mojang.com/browse/MC-195640) - 满饥饿值时不能食用迷之炖菜。
- [MC-195806](https://bugs.mojang.com/browse/MC-195806) - 烟熏炉的顶部和底部材质上有像素颜色不一致的现象。
- [MC-195827](https://bugs.mojang.com/browse/MC-195827) - en_us.json文件中的datapackFailure.title一行中，翻译字符串和等效文本之间有两个空格。
- [MC-196298](https://bugs.mojang.com/browse/MC-196298) - 射中竹子或滴水石锥的边缘的箭不会消失。
- [MC-196425](https://bugs.mojang.com/browse/MC-196425) - 屏幕扭曲效果选项中的“Off（关）”没有全大写，与其他选项不统一。
- [MC-196542](https://bugs.mojang.com/browse/MC-196542) - 对于天空光照传播代码的小型清理。
- [MC-196638](https://bugs.mojang.com/browse/MC-196638) - 放置盔甲架时日志中会输出警告“Trying to add entity with duplicated UUID”。
- [MC-197009](https://bugs.mojang.com/browse/MC-197009) - 在配方书中选择引用物品标签为空的物品会使客户端崩溃。
- [MC-197073](https://bugs.mojang.com/browse/MC-197073) - 海龟在红沙上产卵时出现的粒子是普通沙子的。
- [MC-197140](https://bugs.mojang.com/browse/MC-197140) - 创造模式物品栏中南瓜灯并未被排序在雕刻过的南瓜的后面。
- [MC-197179](https://bugs.mojang.com/browse/MC-197179) - 拾起皮革的幼年猪灵不会自然消失，使得下界满是多余的幼年猪灵。
- [MC-197276](https://bugs.mojang.com/browse/MC-197276) - 食用河豚给予的中毒效果的等级为Ⅳ，而不是Ⅱ。
- [MC-197328](https://bugs.mojang.com/browse/MC-197328) - 在流畅或高品质画质下，在水表面后的实体有时不被渲染。
- [MC-197524](https://bugs.mojang.com/browse/MC-197524) - 世界边界处的区块不会更新毗邻的区块，导致光照更新停止。
- [MC-197561](https://bugs.mojang.com/browse/MC-197561) - 雕刻过的南瓜和南瓜灯可以组成卐字。
- [MC-197616](https://bugs.mojang.com/browse/MC-197616) - 特定的自定义生物群系设置会导致游戏在控制台上刷Received invalid biome id: -1，导致游戏严重卡顿或者卡死。
- [MC-197805](https://bugs.mojang.com/browse/MC-197805) - 尝试制造物品时游戏崩溃（由BungeeCord或Paper导致）。
- [MC-197883](https://bugs.mojang.com/browse/MC-197883) - 拼图方块生成的结构会导致DataFixer在服务器控制台上刷屏。
- [MC-197942](https://bugs.mojang.com/browse/MC-197942) - 熔岩池附近的树叶会变成石头（- [MC-48340的后续问题）。
- [MC-197947](https://bugs.mojang.com/browse/MC-197947) - 创造模式的玩家在雨中站在常燃火中时，熄灭声会一直播放。
- [MC-198129](https://bugs.mojang.com/browse/MC-198129) - 1.16.2中对ReplaceBlobsFeature功能进行的大修改影响了玄武岩三角洲的生成。
- [MC-198200](https://bugs.mojang.com/browse/MC-198200) - 当在模板池中忽略处理器时导致崩溃：java.lang.IllegalArgumentException：边界必须为正数。
- [MC-198414](https://bugs.mojang.com/browse/MC-198414) - 若将/spawnpoint中的角度设为±∞，玩家死亡后将会被踢出，并且重新加入会使游戏崩溃。
- [MC-198432](https://bugs.mojang.com/browse/MC-198432) - 重载游戏后，河豚（实体）可以穿过方块。
- [MC-198514](https://bugs.mojang.com/browse/MC-198514) - 创建只有空气的超平坦世界会导致游戏崩溃。
- [MC-198535](https://bugs.mojang.com/browse/MC-198535) - time_check谓词条件同时需要min和max。
- [MC-198725](https://bugs.mojang.com/browse/MC-198725) - 为超平坦世界预设不存在的生物群系后点击“预设”按钮会导致游戏崩溃。
- [MC-198805](https://bugs.mojang.com/browse/MC-198805) - 守卫者或远古守卫者的尾鳍上有飘浮的像素点。
- [MC-198807](https://bugs.mojang.com/browse/MC-198807) - 让猪灵和猪灵蛮兵对某些实体（如掉落物）产生敌意会使游戏崩溃。
- [MC-198864](https://bugs.mojang.com/browse/MC-198864) - 世界边界在y=0以下及y=255以上的位置不渲染。
- [MC-198957](https://bugs.mojang.com/browse/MC-198957) - 熔岩池附近的末地传送门框架会变成石头。
- [MC-199065](https://bugs.mojang.com/browse/MC-199065) - 被火烧死的僵尸不掉落烤马铃薯。
- [MC-199237](https://bugs.mojang.com/browse/MC-199237) - 梯子的背面材质不与其正面材质相对应。
- [MC-199239](https://bugs.mojang.com/browse/MC-199239) - 藤蔓的背面材质不与其正面材质相对应。
- [MC-199242](https://bugs.mojang.com/browse/MC-199242) - 作物模型的材质平面不与其背面材质相对应。
- [MC-199356](https://bugs.mojang.com/browse/MC-199356) - options.txt文件中的chatDelay选项中，选项名称后的冒号与选项值之间有空格。
- [MC-199543](https://bugs.mojang.com/browse/MC-199543) - 藤蔓的特性同步问题。
- [MC-199988](https://bugs.mojang.com/browse/MC-199988) - 使用/setblock命令显示结构方块的UI时，其材质从“数据”形式更改为“保存”形式。
- [MC-200009](https://bugs.mojang.com/browse/MC-200009) - 在巨型蘑菇的特征帽中使用非蘑菇方块时发生崩溃。
- [MC-200195](https://bugs.mojang.com/browse/MC-200195) - 下船时，船不尝试使玩家在陆地上落脚。
- [MC-200696](https://bugs.mojang.com/browse/MC-200696) - 时钟的材质与材质更新的颜色样式不匹配。
- [MC-200906](https://bugs.mojang.com/browse/MC-200906) - 重载世界时，河豚（实体）的碰撞箱不正确。
- [MC-201269](https://bugs.mojang.com/browse/MC-201269) - 不停将玩家传送到幻翼的位置会导致游戏崩溃或玩家被踢出。
- [MC-201316](https://bugs.mojang.com/browse/MC-201316) - 使用/give命令给予过多物品会导致游戏卡死。
- [MC-201748](https://bugs.mojang.com/browse/MC-201748) - 锁链模型的材质平面不与其背面材质相对应。
- [MC-201751](https://bugs.mojang.com/browse/MC-201751) - 灯笼材质上的锁链部分的材质不与其背面材质相对应。
- [MC-201753](https://bugs.mojang.com/browse/MC-201753) - 海泡菜顶部绿色部分的后面材质显示不正确。
- [MC-201840](https://bugs.mojang.com/browse/MC-201840) - 可选功能标签有时即使存在也不会运行。
- [MC-202186](https://bugs.mojang.com/browse/MC-202186) - 使用/locate命令传送到僵尸村庄时，僵尸村庄中的房子会消失。
- [MC-202202](https://bugs.mojang.com/browse/MC-202202) - 服务器不能避免玩家下船，由此导致不同步。
- [MC-202246](https://bugs.mojang.com/browse/MC-202246) - 溺水实体的导航系统会导致内存溢出或严重的性能下降。
- [MC-202249](https://bugs.mojang.com/browse/MC-202249) - 在新下界区块中的被激怒的被动生物会离旧区块很远，当它们进入下界传送门时会导致服务器卡死。
- [MC-202543](https://bugs.mojang.com/browse/MC-202543) - 创造模式物品栏中的远古残骸排在下界合金块的后面。
- [MC-202760](https://bugs.mojang.com/browse/MC-202760) - area_effect_cloud不强制最大半径。
- [MC-203131](https://bugs.mojang.com/browse/MC-203131) - 在模板池中把权重设置为一个很高的值时，会导致世界卡住和内存不足错误。
- [MC-203300](https://bugs.mojang.com/browse/MC-203300) - 创造模式物品栏中的下界金矿石没有与下界石英矿石排列在一起。
- [MC-203373](https://bugs.mojang.com/browse/MC-203373) - 字幕中，潜影贝导弹的英文大小写不正确。
- [MC-203374](https://bugs.mojang.com/browse/MC-203374) - 被潜影贝破坏的下落方块有很强的方向偏差。
- [MC-203397](https://bugs.mojang.com/browse/MC-203397) - 在同一格内放置藤蔓会使得原有藤蔓的方向发生改变。
- [MC-205477](https://bugs.mojang.com/browse/MC-205477) - 服务器延迟较高时，尝试坐船和下船会偶尔导致不同步。
- [MC-205735](https://bugs.mojang.com/browse/MC-205735) - 幼年牛可以在台阶中窒息。
- [MC-205797](https://bugs.mojang.com/browse/MC-205797) - 僵尸疣猪兽会攻击带Marker属性的盔甲架和隐形盔甲架。
- [MC-206560](https://bugs.mojang.com/browse/MC-206560) - 河豚会对带Marker属性的盔甲架和隐形盔甲架有反应。
- [MC-207125](https://bugs.mojang.com/browse/MC-207125) - 装填的弩在副手状态下不会显示破坏方块的手部动画。
- [MC-207173](https://bugs.mojang.com/browse/MC-207173) - 在多人游戏菜单的直接连接中，只输入冒号并回车会导致游戏崩溃。
- [MC-207405](https://bugs.mojang.com/browse/MC-207405) - 可以通过将下界之星放在潜影盒/收纳袋中来炸毁它。
- [MC-208082](https://bugs.mojang.com/browse/MC-208082) - 在会话过期下聊天信息显示会导致游戏停止。
- [MC-208430](https://bugs.mojang.com/browse/MC-208430) - 在加载资源包时，游戏会由于tessellating block model而崩溃。
- [MC-208639](https://bugs.mojang.com/browse/MC-208639) - 当玩家获得磨制黑石而不是磨制黑石台阶时，会解锁錾制磨制黑石的合成配方。
- [MC-209361](https://bugs.mojang.com/browse/MC-209361) - 迅速将竹笋下方的方块替换为竹子会导致游戏崩溃。
- [MC-209625](https://bugs.mojang.com/browse/MC-209625) - 幼年羊驼可以在地毯上受到头顶固体方块的窒息伤害。
- [MC-209819](https://bugs.mojang.com/browse/MC-209819) - 服务器会在寻路到一个被传送到很远的玩家处时崩溃。
- [MC-210408](https://bugs.mojang.com/browse/MC-210408) - /spawnpoint命令允许玩家设置一个越界的坐标，导致玩家重生时游戏崩溃。
- [MC-210791](https://bugs.mojang.com/browse/MC-210791) - 潜影贝可以把正在掉落的物品弹起来。
- [MC-211064](https://bugs.mojang.com/browse/MC-211064) - 加载大小越界的TrueType字体时，游戏崩溃。
- [MC-212123](https://bugs.mojang.com/browse/MC-212123) - 在背包中显示的玩家各面的亮度不一致，前面看起来要更暗。
- [MC-212291](https://bugs.mojang.com/browse/MC-212291) - 客户端可以独立的将玩家从载具中卸下，导致服务器的不同步。
- [MC-213062](https://bugs.mojang.com/browse/MC-213062) - 废弃传送门会在末地传送门中间生成。
- [MC-214568](https://bugs.mojang.com/browse/MC-214568) - 着火的讲台会引起深度冲突（Z-Fighting）。
- [MC-214586](https://bugs.mojang.com/browse/MC-214586) - 没有最适合挖掘缠根泥土的工具。
- [MC-214589](https://bugs.mojang.com/browse/MC-214589) - 末地折跃门的出口传送门可以被设置在非常高的高度上，并由此导致玩家被踢出。
- [MC-214629](https://bugs.mojang.com/browse/MC-214629) - 无论辅助功能设置中的视场角设置如何，在水下视场角都会减小。
- [MC-214693](https://bugs.mojang.com/browse/MC-214693) - 绊线的背面材质不与其正面材质相对应。
- [MC-214694](https://bugs.mojang.com/browse/MC-214694) - 绊线与绊线钩连接部分的背面材质不与其正面材质相对应。
- [MC-214879](https://bugs.mojang.com/browse/MC-214879) - 没有选中任何东西时按Ctrl + C会清空剪切板。
- [MC-215534](https://bugs.mojang.com/browse/MC-215534) - 玩家头戴雕刻过的南瓜时旁观一个有着色器的生物会导致屏幕完全变白。
- [MC-216227](https://bugs.mojang.com/browse/MC-216227) - 自13w36a开始，物品栏的甘蔗材质和放置后的材质颜色不再匹配。
- [MC-216510](https://bugs.mojang.com/browse/MC-216510) - 世界边界上的红色效果会影响生物着色器的亮度。
- [MC-218112](https://bugs.mojang.com/browse/MC-218112) - SynchedEntityDatas中使用线程锁的方法有误。
- [MC-218888](https://bugs.mojang.com/browse/MC-218888) - 使用⇧ Shift键把物品点入物品栏中时，相关进度不会被触发。
- [MC-218972](https://bugs.mojang.com/browse/MC-218972) - 实体隐形时，发光效果的光圈会忽略实体的一部分。
- [MC-220335](https://bugs.mojang.com/browse/MC-220335) - 信标光柱不会被水的迷雾所遮挡。
- [MC-220694](https://bugs.mojang.com/browse/MC-220694) - 知识之书名字的颜色不正确。
- [MC-220698](https://bugs.mojang.com/browse/MC-220698) - 恶魂火球的ExplosionPower值无上限，数值过高时会引起卡顿或崩溃。
- [MC-221819](https://bugs.mojang.com/browse/MC-221819) - 不一致性：末影人能拿起盛开的杜鹃树叶，但不能拿起其他种类的树叶。
- [MC-222189](https://bugs.mojang.com/browse/MC-222189) - 随着方块实体数量的增加，活塞延迟会大幅度升高。
- [MC-223227](https://bugs.mojang.com/browse/MC-223227) - 海底洞穴中的水体呈悬浮状态。
- [MC-223322](https://bugs.mojang.com/browse/MC-223322) - 在出生点保护范围内，紫颂花可以被弹射物所破坏。
- [MC-223552](https://bugs.mojang.com/browse/MC-223552) - 鸣谢名单未按字母排序。
- [MC-223558](https://bugs.mojang.com/browse/MC-223558) - 使用玻璃瓶从炼药锅中取水不会使minecraft.used:minecraft.glass_bottle统计值增加。
- [MC-223563](https://bugs.mojang.com/browse/MC-223563) - 使用玻璃瓶从蜂巢或蜂箱中取蜂蜜不会使minecraft.used:minecraft.glass_bottle统计值增加。
- [MC-223602](https://bugs.mojang.com/browse/MC-223602) - 带有发光状态效果的半透明实体的轮廓不正常相连。
- [MC-223638](https://bugs.mojang.com/browse/MC-223638) - 使用剪刀雕刻南瓜不会使minecraft.used:minecraft.shears统计值增加。
- [MC-223639](https://bugs.mojang.com/browse/MC-223639) - 使用剪刀从蜂巢或峰箱上取蜜脾不会使minecraft.used:minecraft.shears统计值增加。
- [MC-223755](https://bugs.mojang.com/browse/MC-223755) - 用水桶充满炼药锅时，minecraft.used:minecraft.water_bucket统计项不增加。
- [MC-224778](https://bugs.mojang.com/browse/MC-224778) - 不具有facing方块状态的方块在具有#wall_corals标签的暖水海洋中时，游戏崩溃。
- [MC-225077](https://bugs.mojang.com/browse/MC-225077) - 藤蔓可以向上生长到不完整方块上。
- [MC-225815](https://bugs.mojang.com/browse/MC-225815) - 地牢中的刷怪笼会被石头替换掉。

未公开漏洞

- [MC-136551](https://bugs.mojang.com/browse/MC-136551) - 服务器可以绕过EULA黑名单。
- [MC-189949](https://bugs.mojang.com/browse/MC-189949) - 信标可以使物品栏失去同步。
- [MC-213869](https://bugs.mojang.com/browse/MC-213869) - 经验复制漏洞。
- [MC-217407](https://bugs.mojang.com/browse/MC-217407) - /setblock命令无法替换打开的桶（允许在多人游戏中复制桶）。
- [MC-224580](https://bugs.mojang.com/browse/MC-224580) - 海豚复制漏洞。

其他漏洞

- 改善了玩家在网络延迟较高时离开船只失去同步的问题。
- 修复了一些崩溃问题。
